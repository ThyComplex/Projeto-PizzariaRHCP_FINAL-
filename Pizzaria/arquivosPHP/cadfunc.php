...
<body>
   ...
   <form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>"> 
      ...
      <input type="text" name="codcarg" placeholder="Cargo">
      <input type="submit" value="Search" name="NeuroticBreakdown">
      <input type="submit" value="Search All" name="SearchAll">
...
?> 
      ...
      <br>
      <input type="text" id="nomfunc" name="nomfunc" size="54" placeholder="Nome do Funcionario" ><br>  
      <input type="text" name="cpf" size="20" placeholder="CPF"> <br>
      <input type="text" name="telephone" size="18" placeholder="Telephone"> <br>
      <input type="text" name="endereco" size="54" placeholder="Endereco" ><br>
      <input type="date" name="dtini" size="15" > <br>
