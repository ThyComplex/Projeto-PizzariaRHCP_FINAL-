...
<body>
    <div style="background-color:#f3e9b5;padding: 5%; border: 1px, solid,#000; border-radius: 10%;display: flex;justify-content: center;">
    
    <div style="height: 400px ;margin-right:30px;width:400px;border-radius: 10%; background-image: url(imagens/img1.jpeg); background-size:cover ; ">
        ...
        <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
           ...
           <input type="submit" name="alterar" value="Alterar">
            ...
            <button><a href="home.html">Voltar a Pagina Inicial ?</a></button> <br>
